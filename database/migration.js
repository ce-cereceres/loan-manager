...
// LENDER
const lender = `CREATE TABLE IF NOT EXISTS lender (
...
// BORROWER
const borrower = `CREATE TABLE IF NOT EXISTS borrower (
                        id integer NOT NULL PRIMARY KEY,
                        name varchar(500) NOT NULL,
...
// INTEREST
const interest = `CREATE TABLE IF NOT EXISTS interest (
                        id integer NOT NULL PRIMARY KEY,
                        loan_id integer NOT NULL,
                        quantity decimal(10,2) NOT NULL,
...
// LOAN
const loan = `CREATE TABLE IF NOT EXISTS loan (
                    id integer NOT NULL PRIMARY KEY,
